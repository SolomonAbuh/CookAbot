...
class MouthTabView extends ConsumerWidget {
  const MouthTabView({
    super.key,
  });
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: List.generate(
          MouthCollection.collection.length,
          (index) => InkWell(
            onTap: () =>
                botttNotifier.updateMouth(MouthCollection.collection[index].id),
            child: Padding(
                ...
                children: [
                          ...
                          Positioned(
                            ...
                            child: BotttCharacter(
                              ...
                              bottt: bottt.copyWith(
                                mouth: MouthCollection.collection[index].id,
                              ),
                            ),
                          ),
                        ],
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      border: index == bottt.mouth.index
                          ? Border.all(
