...
class SideTabView extends ConsumerWidget {
  const SideTabView({
    Key? key,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: List.generate(
          SideCollection.collection.length,
          (index) => InkWell(
            onTap: () =>
                botttNotifier.updateSide(SideCollection.collection[index].id),
            child: Padding(
                          ...
                          Positioned(
                            ...
                            child: BotttCharacter(
                              ...
                              bottt: bottt.copyWith(
                                side: SideCollection.collection[index].id,
                              ),
                            ),
                          ),
                        ],
